...
![GET - Listar todas as cartas](insomnia-test-img/get-test.png)

![POST - Criar nova carta](insomnia-test-img/post-test.png)

![PUT - Atualizar carta existente](insomnia-test-img/put-test.png)
